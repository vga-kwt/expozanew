...
const CreateAd = ({ products, expos, linkTypeOptions, vendors }: CreateAdProps) => {
    ...
    useEffect(() => {
        if (!data.start_date) {
            setData('start_date', getTomorrowDate());
        }
    }, []);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('ads.store'), {
            ...
            onError: () => toast.error("Please fill mandatory details to create the ad."),
        });
    };
                            ...
                            <div className="p-6">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex justify-end gap-2">
                                        ...
                                        <Button type="button" variant="outline" onClick={() => router.visit(route('ads.index'))}>
                                            Cancel
                                        </Button>
                                    </div>
                                </form>
