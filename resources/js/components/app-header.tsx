                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="relative flex h-9 w-16 cursor-pointer items-center justify-between rounded-full px-2.5 bg-muted"
                                aria-label={appearance === 'light' ? 'Switch to dark mode' : 'Switch to light mode'}
                            >
                                <Sun size={14} className="relative z-20 text-muted-foreground opacity-80" />
                                <Moon size={14} className="relative z-20 text-muted-foreground opacity-80" />
                                <div
                                    className={`absolute top-0.5 left-0.5 h-7 w-7 rounded-full bg-background shadow-sm border transition-transform duration-500 ${circleOnStart ? 'translate-x-0' : 'translate-x-8'}`}
                                />
                            </button>
                        </div>
