...
class FinanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Finance/Index', [
            ...
            'vendors' => $vendors,
            'filters' => $filters,
            'transactionTypes' => $this->financeService->getTransactionTypes(),
        ]);
    }
     ...
     */
    public function completePayout(VendorPayout $payout)
    {
        $payout->update([
            'status' => 'completed',
            'processed_date' => now(),
     ...
     */
    public function cancelPayout(Request $request, VendorPayout $payout)
    {
        $request->validate([
            'notes' => 'required|string',
        ]);
    ...
    {
        $filters = $this->getTransactionFilters($request);
        $filepath = $this->financeService->exportTransactions($filters);
